...
3.) After receiving your email, the Tyler D&I Project Team will create an Error Report Workbook using the JSON provided. The workbook will include a listing of each error that exists in the JSON.
