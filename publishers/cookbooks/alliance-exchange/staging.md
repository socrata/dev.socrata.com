...
- Staging requires Live Data instead of Mock Data.
    ...
    - Because data integrity is more important in this environment, the environment allows you to perform modifications of specific records when there is erroneous or unwanted data present.  Please see the following section on the Definitions and Guidance page that discusses how to perform Edits and Deletions: [Guidance and Best Practices for Data Modification](./staging-definitions.md#guidance-and-best-practices-for-data-modification-edits-and-deletions) 
...
- Additional Properties are not allowed 
    ...
    - Please see the following section for how to fix this [4.2.3 Additional Properties](./staging-instructions.md#423-additional-properties)
...
- Type checking is enforced
    ...
    - Please see the following section for how to fix type errors: [4.2.4 Type](./staging-instructions.md#424-type) 
- Formatting pattern matching is enforced
    - Please see the following section for how to fix pattern-matching errors [4.2.2 Keyword Pattern](./staging-instructions.md#422-keyword-pattern) 
- Categorical Data Elements only accept allowed values
    ...
    - Please see the following section for how to fix categorical/enumeration errors: [4.2.5 Categorical Variable Enumeration](./staging-instructions.md#425-categorical-variable-enumeration)

## Other resources
- [Staging pipeline instructions and FAQs](./staging_instructions.md)
- [Staging definitions and guidance](./staging_definitions.md)
